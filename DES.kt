...
fun main(args: Array<String>) {
    ...
    val inputBinary = getInput(inputHex)
    ...
    for (i in 0 until  8){
        ...
        hexPerm += Integer.toHexString(boxes[i][row][col])
...
private fun getKey(keyHex: String) : String{
    ...
    return handleLeftZeros(keyBinary1, 16) + handleLeftZeros(keyBinary2, 16) + handleLeftZeros(keyBinary3, 16)
}
